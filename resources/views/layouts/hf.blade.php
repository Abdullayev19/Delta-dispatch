...
<head>
  ...
  <script>
    window.replainSettings = { id: 'b5af9fc9-f9e9-44d7-ba7b-7c65e01800cf' };
  ...
  <header id="header">
    <div class="container-fluid">
      ...
      <div id="logo" class="pull-left">
        <a href="#">
          <img src="img/favicon.png" style="width: 8rem; margin-top: -.5rem;">
        </a>
      </div>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-3 col-md-6 footer-info">
          <img src="img/favicon.png" class="w-50 mb-3">
